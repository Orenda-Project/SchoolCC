...
export default function PWAInstallBanner() {
  ...
  useEffect(() => {
    ...
    // Check if running in native app (Capacitor/WebView) or already installed
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-[100] bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white shadow-xl animate-in slide-in-from-top-5 duration-700">
