...
const mockActivities: Activity[] = [
  {
    ...
    reactions: [
      { id: 'r-1', type: 'love', userId: 'aeo-1', userName: 'Mr. Amit Patel' },
      { id: 'r-2', type: 'clap', userId: 'head-1', userName: 'Mr. Rajesh Kumar' },
    ],
  ...
  },
  {
    ...
    comments: [],
    reactions: [
      { id: 'r-3', type: 'celebrate', userId: 'head-1', userName: 'Mr. Rajesh Kumar' },
    ],
