...
const createInitialVisits = (): SchoolVisit[] => {
  ...
  return [
    // Active Visits (in_progress) - for real-time tracking
    {
      ...
      conductedBy: 'aeo-5',
      conductedByName: realAEOs[4].name,
      conductedByRole: 'AEO',
      status: 'in_progress',
    ...
    },
    {
      id: 'v-active-2',
      schoolId: 'SCH-008',
      schoolName: 'GPS DHAMIAL',
      visitDate: now,
      plannedDate: now,
      visitType: 'mentoring',
      conductedBy: 'aeo-9',
      conductedByName: realAEOs[8].name,
      conductedByRole: 'AEO',
      status: 'in_progress',
    ...
    },
    {
      id: 'v-active-3',
      schoolId: 'SCH-013',
      schoolName: 'GPS REHMATABAD',
      visitDate: now,
      plannedDate: now,
      visitType: 'monitoring',
      conductedBy: 'aeo-16',
      conductedByName: realAEOs[15].name,
      conductedByRole: 'AEO',
      status: 'in_progress',
    ...
    // Completed Visits
    {
      ...
      visitType: 'monitoring',
      conductedBy: 'aeo-1',
      conductedByName: realAEOs[0].name,
      conductedByRole: 'AEO',
      status: 'completed',
    ...
    },
    {
      ...
      visitType: 'mentoring',
      conductedBy: 'aeo-3',
      conductedByName: realAEOs[2].name,
      conductedByRole: 'AEO',
      status: 'completed',
